...
id.prototype.fa=function(){if(this.v)for(;this.v.length;)this.v.shift()()};function jd(a,b){this.type=a;this.h=this.target=b;this.defaultPrevented=this.j=!1}
...
return a.h}
;function Td(){var a={};this.A=function(b,c){return null!=a[b]?a[b]:c}}
...
function sg(a){var b=N("EXPERIMENTS_FORCED_FLAGS",{});return void 0!==b[a]?b[a]:N("EXPERIMENT_FLAGS",{})[a]}
function ug(){var a=[],b=N("EXPERIMENTS_FORCED_FLAGS",{});for(c in b)a.push({key:c,value:String(b[c])});var c=N("EXPERIMENT_FLAGS",{});for(var d in c)d.startsWith("force_")&&void 0===b[d]&&a.push({key:d,value:String(c[d])});return a}
...
null==(p=Hc.screen)?void 0:p.availWidth;var u;e.u_cd=null==(u=Hc.screen)?void 0:u.colorDepth}catch(wa){}h=b.h;try{var q=h.screenX;var x=h.screenY}catch(wa){}try{var y=h.outerWidth;var A=h.outerHeight}catch(wa){}try{var M=h.innerWidth;var O=h.innerHeight}catch(wa){}try{var P=h.screenLeft;var Ob=h.screenTop}catch(wa){}try{M=h.innerWidth,O=h.innerHeight}catch(wa){}try{var Zd=h.screen.availWidth;var Yj=h.screen.availTop}catch(wa){}q=[P,Ob,q,x,Zd,Yj,y,A,M,O];x=b.h.top;try{var ea=(x||window).document,V=
"CSS1Compat"==ea.compatMode?ea.documentElement:ea.body;var la=(new Ic(V.clientWidth,V.clientHeight)).round()}catch(wa){la=new Ic(-12245933,-12245933)}ea=la;la={};V=new Rd;B.SVGElement&&B.document.createElementNS&&V.set(0);x=Tc();x["allow-top-navigation-by-user-activation"]&&V.set(1);x["allow-popups-to-escape-sandbox"]&&V.set(2);B.crypto&&B.crypto.subtle&&V.set(3);B.TextDecoder&&B.TextEncoder&&V.set(4);V=Sd(V);la.bc=V;la.bih=ea.height;la.biw=ea.width;la.brdim=q.join();b=b.i;ea="Da";Td.Da&&Td.hasOwnProperty(ea)?
ea=Td.Da:(V=new Td,Td.Da=V,Td.hasOwnProperty(ea),ea=V);b=(la.vis=ea.A(Wc.flag,Wc.defaultValue)&&b.prerendering?3:{visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[b.visibilityState||b.webkitVisibilityState||b.mozVisibilityState||""]||0,la.wgl=!!Hc.WebGLRenderingContext,la);c=d.call(c,e,b);c.ca_type="image";a&&(c.bid=a);return c}
...
function Pg(a,b){b.includeDomain&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=N("XSRF_FIELD_NAME",void 0);if(b=b.urlParams)b[c]&&delete b[c],a=qg(a,b||{},!0);return a}
function Qg(a,b){var c=N("XSRF_FIELD_NAME",void 0),d=N("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.postParams,g=N("XSRF_FIELD_NAME",void 0),h;b.headers&&(h=b.headers["Content-Type"]);b.excludeXsrf||Ib(a)&&!b.withCredentials&&Ib(a)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.postParams&&b.postParams[g]||(f||(f={}),f[c]=d);f&&"string"===typeof e&&(e=pg(e),hb(e,f),e=b.postBodyFormat&&"JSON"==b.postBodyFormat?JSON.stringify(e):Lb(e));if(!(a=e)&&(a=f)){a:{for(var k in f){f=
...
Eb&&a.constructor===Eb?a=a.h:(Ka(a),a="type_error:SafeHtml"),a=encodeURIComponent(String(Ce(a.toString())))),/^[\s\xa0]*$/.test(a)||(a=Lc("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+'+"\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a)));else if(e)Rg(a,b,"POST",e,d);else if(N("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d)Rg(a,b,"GET","",d);else{b:{try{var f=new Ua({url:a});if(f.j&&f.i||f.l){var g=Hb(a.match(Gb)[5]||null);var h=!(!g||!g.endsWith("/aclk")||
"1"!==Nb(a,"ri"));break b}}catch(k){}h=!1}h?ah(a)?(b&&b(),c=!0):c=!1:c=!1;c||bh(a,b)}}
...
a?nh.h=b:mh.h=b}window.clearTimeout(a?nh.i:mh.i);b=N("LOGGING_BATCH_TIMEOUT",tg("web_gel_debounce_ms",1E4));Q("shorten_initial_gel_batch_timeout")&&oh&&(b=ih);b=hg(function(){vh({writeThenSend:!0},void 0,a)},b);
a?nh.i=b:mh.i=b}
...
function Dh(a,b,c){a.requestTimeMs=String(b);Q("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);!c&&(b=N("EVENT_ID",void 0))&&(c=Kh(),a.serializedClientEventId={serializedEventId:b,clientCounter:String(c)})}
function Jh(a,b,c){J(a,2,b);if(!c&&(b=N("EVENT_ID",void 0))){c=Kh();var d=new Bf;J(d,1,b);J(d,2,c);Cc(a,5,d)}}
function Kh(){var a=N("BATCH_CLIENT_COUNTER",void 0)||0;a||(a=Math.floor(Math.random()*jh/2));a++;a>jh&&(a=1);Tf("BATCH_CLIENT_COUNTER",a);return a}
...
function Ih(a,b,c){if(xc(c,1===zc(c,Cf)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;Cc(a,4,c);a=Ac(a,yf,1)||new yf;c=Ac(a,wf,3)||new wf;var e=new vf;e.setToken(b);J(e,1,d);Dc(c,12,vf,e);Cc(a,3,c)}
...
function Bh(){return{innertubeApiKey:N("INNERTUBE_API_KEY",void 0),innertubeApiVersion:N("INNERTUBE_API_VERSION",void 0),Ba:N("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Ca:N("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),pb:N("INNERTUBE_CONTEXT_CLIENT_NAME",1),innertubeContextClientVersion:N("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),Ua:N("INNERTUBE_CONTEXT_HL",void 0),Ta:N("INNERTUBE_CONTEXT_GL",void 0),qb:N("INNERTUBE_HOST_OVERRIDE",void 0)||"",sb:!!N("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),rb:!!N("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1),appInstallData:N("SERIALIZED_CLIENT_CONFIG_DATA",void 0)}}
function Ah(a){var b={client:{hl:a.Ua,gl:a.Ta,clientName:a.Ca,clientVersion:a.innertubeContextClientVersion,configInfo:a.Ba}};navigator.userAgent&&(b.client.userAgent=String(navigator.userAgent));var c=B.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=N("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=ug();0<c.length&&(b.request={internalExperimentFlags:c});Uh(a,void 0,b);Vh(a,void 0,b);Wh(void 0,b);Xh(a,void 0,b);Yh(void 0,b);N("DELEGATED_SESSION_ID")&&!Q("pageid_as_header_web")&&
(b.user={onBehalfOfUser:N("DELEGATED_SESSION_ID")});a=Object;c=a.assign;for(var d=b.client,e={},f=t(Object.entries(pg(N("DEVICE","")))),g=f.next();!g.done;g=f.next()){var h=t(g.value);g=h.next().value;h=h.next().value;"cbrand"===g?e.deviceMake=h:"cmodel"===g?e.deviceModel=h:"cbr"===g?e.browserName=h:"cbrver"===g?e.browserVersion=h:"cos"===g?e.osName=h:"cosver"===g?e.osVersion=h:"cplatform"===g&&(e.platform=h)}b.client=c.call(a,d,e);return b}
...
Dc(e,15,mf,g)}Cc(b,5,e)}Uh(a,c);Vh(a,c);Wh(c);Xh(a,c);Yh(c);N("DELEGATED_SESSION_ID")&&!Q("pageid_as_header_web")&&(a=new wf,J(a,3,N("DELEGATED_SESSION_ID")));a=t(Object.entries(pg(N("DEVICE",""))));for(d=a.next();!d.done;d=a.next())e=t(d.value),d=e.next().value,e=e.next().value,"cbrand"===d?J(c,12,e):"cmodel"===d?J(c,13,e):"cbr"===d?J(c,87,e):"cbrver"===d?J(c,88,e):"cos"===d?J(c,18,e):"cosver"===d?J(c,19,e):"cplatform"===d&&J(c,42,e);Cc(b,1,c);return b}
...
function Zh(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||N("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Pb||N("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().Ob:b=gd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=N("SESSION_INDEX",0),Q("pageid_as_header_web")&&(d["X-Goog-PageId"]=N("DELEGATED_SESSION_ID")));return d}
;function $h(a){a=Object.assign({},a);delete a.Authorization;var b=gd();if(b){var c=new le;c.update(N("INNERTUBE_API_KEY",void 0));c.update(b);a.hash=jc(c.digest(),3)}return a}
...
function oi(){if(void 0!==N("DATASYNC_ID",void 0))return N("DATASYNC_ID",void 0);throw new mi("Datasync ID not set","unknown");}
;function pi(a){if(0<=a.indexOf(":"))throw Error("Database name cannot contain ':'");}
function qi(a){return a.substr(0,a.indexOf(":"))||a}
;var S={},ri=(S.AUTH_INVALID="No user identifier specified.",S.EXPLICIT_ABORT="Transaction was explicitly aborted.",S.IDB_NOT_SUPPORTED="IndexedDB is not supported.",S.MISSING_INDEX="Index not created.",S.MISSING_OBJECT_STORES="Object stores not created.",S.DB_DELETED_BY_MISSING_OBJECT_STORES="Database is deleted because expected object stores were not created.",S.DB_REOPENED_BY_MISSING_OBJECT_STORES="Database is reopened because expected object stores were not created.",S.UNKNOWN_ABORT="Transaction was aborted for unknown reasons.",
S.QUOTA_EXCEEDED="The current transaction exceeded its quota limitations.",S.QUOTA_MAYBE_EXCEEDED="The current transaction may have failed because of exceeding quota limitations.",S.EXECUTE_TRANSACTION_ON_CLOSED_DB="Can't start a transaction on a closed database",S.INCOMPATIBLE_DB_VERSION="The binary is incompatible with the database version",S),T={},si=(T.AUTH_INVALID="ERROR",T.EXECUTE_TRANSACTION_ON_CLOSED_DB="WARNING",T.EXPLICIT_ABORT="IGNORED",T.IDB_NOT_SUPPORTED="ERROR",T.MISSING_INDEX="WARNING",
T.MISSING_OBJECT_STORES="ERROR",T.DB_DELETED_BY_MISSING_OBJECT_STORES="WARNING",T.DB_REOPENED_BY_MISSING_OBJECT_STORES="WARNING",T.QUOTA_EXCEEDED="WARNING",T.QUOTA_MAYBE_EXCEEDED="WARNING",T.UNKNOWN_ABORT="WARNING",T.INCOMPATIBLE_DB_VERSION="WARNING",T),ti={},ui=(ti.AUTH_INVALID=!1,ti.EXECUTE_TRANSACTION_ON_CLOSED_DB=!1,ti.EXPLICIT_ABORT=!1,ti.IDB_NOT_SUPPORTED=!1,ti.MISSING_INDEX=!1,ti.MISSING_OBJECT_STORES=!1,ti.DB_DELETED_BY_MISSING_OBJECT_STORES=!1,ti.DB_REOPENED_BY_MISSING_OBJECT_STORES=!1,ti.QUOTA_EXCEEDED=
!1,ti.QUOTA_MAYBE_EXCEEDED=!0,ti.UNKNOWN_ABORT=!0,ti.INCOMPATIBLE_DB_VERSION=!1,ti);function U(a,b,c,d,e){b=void 0===b?{}:b;c=void 0===c?ri[a]:c;d=void 0===d?si[a]:d;e=void 0===e?ui[a]:e;mi.call(this,c,Object.assign({name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a},b));this.type=a;this.message=c;this.level=d;this.h=e;Object.setPrototypeOf(this,U.prototype)}
v(U,mi);function vi(a,b){U.call(this,"MISSING_OBJECT_STORES",{expectedObjectStores:b,foundObjectStores:a},ri.MISSING_OBJECT_STORES);Object.setPrototypeOf(this,vi.prototype)}
v(vi,U);function wi(a,b){var c=Error.call(this);this.message=c.message;"stack"in c&&(this.stack=c.stack);this.index=a;this.objectStore=b;Object.setPrototypeOf(this,wi.prototype)}
v(wi,Error);var xi=["The database connection is closing","Can't start a transaction on a closed database","A mutation operation was attempted on a database that did not allow mutations"];
function yi(a,b,c,d){b=qi(b);var e=a instanceof Error?a:Error("Unexpected error: "+a);if(e instanceof U)return e;a={objectStoreNames:c,dbName:b,dbVersion:d};if("QuotaExceededError"===e.name)return new U("QUOTA_EXCEEDED",a);if(gc&&"UnknownError"===e.name)return new U("QUOTA_MAYBE_EXCEEDED",a);if(e instanceof wi)return new U("MISSING_INDEX",Object.assign(Object.assign({},a),{objectStore:e.objectStore,index:e.index}));if("InvalidStateError"===e.name&&xi.some(function(f){return e.message.includes(f)}))return new U("EXECUTE_TRANSACTION_ON_CLOSED_DB",
a);
...
function zi(a,b,c){var d=hi();return new U("IDB_NOT_SUPPORTED",{context:{caller:a,publicName:b,version:c,hasSucceededOnce:null===d||void 0===d?void 0:d.hasSucceededOnce}})}
;function Ai(a){if(!a)throw Error();throw a;}
...
W.all=function(a){return new W(new Ci(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={Z:0};f.Z<a.length;f={Z:f.Z},++f.Z)Di(W.resolve(a[f.Z]).then(function(g){return function(h){d[g.Z]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})}))};
W.resolve=function(a){return new W(new Ci(function(b,c){a instanceof W?a.then(b,c):b(a)}))};
W.reject=function(a){return new W(new Ci(function(b,c){c(a)}))};
W.prototype.then=function(a,b){var c=this,d=null!==a&&void 0!==a?a:Bi,e=null!==b&&void 0!==b?b:Ai;return new W(new Ci(function(f,g){"PENDING"===c.state.status?(c.h.push(function(){Ei(c,c,d,f,g)}),c.onRejected.push(function(){Fi(c,c,e,f,g)})):"FULFILLED"===c.state.status?Ei(c,c,d,f,g):"REJECTED"===c.state.status&&Fi(c,c,e,f,g)}))};
...
function X(a){return new W(new Ci(function(b,c){Hi(a,b,c)}))}
;function Ji(a,b){return new W(new Ci(function(c,d){function e(){var f=a?b(a):null;f?f.then(function(g){a=g;e()},d):c()}
e()}))}
;function Ki(a,b){this.h=a;this.options=b;this.transactionCount=0;this.j=Math.round(R());this.i=!1}
m=Ki.prototype;m.add=function(a,b,c){return Li(this,[a],{mode:"readwrite",G:!0},function(d){return d.objectStore(a).add(b,c)})};
m.clear=function(a){return Li(this,[a],{mode:"readwrite",G:!0},function(b){return b.objectStore(a).clear()})};
m.close=function(){var a;this.h.close();(null===(a=this.options)||void 0===a?0:a.closed)&&this.options.closed()};
m.count=function(a,b){return Li(this,[a],{mode:"readonly",G:!0},function(c){return c.objectStore(a).count(b)})};
function Mi(a,b,c){a=a.h.createObjectStore(b,c);return new Ni(a)}
m.delete=function(a,b){return Li(this,[a],{mode:"readwrite",G:!0},function(c){return c.objectStore(a).delete(b)})};
m.get=function(a,b){return Li(this,[a],{mode:"readonly",G:!0},function(c){return c.objectStore(a).get(b)})};
function Oi(a,b){return Li(a,["LogsRequestsStore"],{mode:"readwrite",G:!0},function(c){c=c.objectStore("LogsRequestsStore");return X(c.h.put(b,void 0))})}
m.objectStoreNames=function(){return Array.from(this.h.objectStoreNames)};
function Li(a,b,c,d){var e,f,g,h,k,l,n,p,u,q,x,y;return z(function(A){switch(A.h){case 1:var M={mode:"readonly",G:!1,tag:"IDB_TRANSACTION_TAG_UNKNOWN"};"string"===typeof c?M.mode=c:Object.assign(M,c);e=M;a.transactionCount++;f=e.G?3:1;g=0;case 2:if(h){A.o(3);break}g++;k=Math.round(R());sa(A,4);l=a.h.transaction(b,e.mode);M=new Pi(l);M=Qi(M,d);return w(A,M,6);case 6:return n=A.i,p=Math.round(R()),Ri(a,k,p,g,void 0,b.join(),e),A.return(n);case 4:u=ua(A);q=Math.round(R());x=yi(u,a.h.name,b.join(),a.h.version);
if((y=x instanceof U&&!x.h)||g>=f)Ri(a,k,q,g,x,b.join(),e),h=x;A.o(2);break;case 3:return A.return(Promise.reject(h))}})}
function Ri(a,b,c,d,e,f,g){b=c-b;e?(e instanceof U&&("QUOTA_EXCEEDED"===e.type||"QUOTA_MAYBE_EXCEEDED"===e.type)&&li("QUOTA_EXCEEDED",{dbName:qi(a.h.name),objectStoreNames:f,transactionCount:a.transactionCount,transactionMode:g.mode}),e instanceof U&&"UNKNOWN_ABORT"===e.type&&(c-=a.j,0>c&&c>=Math.pow(2,31)&&(c=0),li("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:f,transactionDuration:b,transactionCount:a.transactionCount,dbDuration:c}),a.i=!0),Si(a,!1,d,f,b,g.tag),ki(e)):Si(a,!0,d,f,b,g.tag)}
function Si(a,b,c,d,e,f){li("TRANSACTION_ENDED",{objectStoreNames:d,connectionHasUnknownAbortedTransaction:a.i,duration:e,isSuccessful:b,tryCount:c,tag:void 0===f?"IDB_TRANSACTION_TAG_UNKNOWN":f})}
m.getName=function(){return this.h.name};
function Ni(a){this.h=a}
m=Ni.prototype;m.add=function(a,b){return X(this.h.add(a,b))};
...
m.index=function(a){try{return new Vi(this.h.index(a))}catch(b){if(b instanceof Error&&"NotFoundError"===b.name)throw new wi(a,this.h.name);throw b;}};
m.getName=function(){return this.h.name};
...
function Qi(a,b){var c=new Promise(function(d,e){try{Di(b(a).then(function(f){d(f)}),e)}catch(f){e(f),a.abort()}});
return Promise.all([c,a.done]).then(function(d){return t(d).next().value})}
Pi.prototype.abort=function(){this.h.abort();this.i=!0;throw new U("EXPLICIT_ABORT");};
...
m=Vi.prototype;m.count=function(a){return X(this.h.count(a))};
...
function Wi(a){return X(a).then(function(b){return b?new Yi(a,b):null})}
...
m.update=function(a){return X(this.cursor.update(a))};function Zi(a,b,c){return new Promise(function(d,e){function f(){u||(u=new Ki(g.result,{closed:p}));return u}
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.blocked,k=c.blocking,l=c.wb,n=c.upgrade,p=c.closed,u;g.addEventListener("upgradeneeded",function(q){try{if(null===q.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");q.dataLoss&&"none"!==q.dataLoss&&li("IDB_DATA_CORRUPTED",{reason:q.dataLossMessage||"unknown reason",dbName:qi(a)});var x=f(),y=new Pi(g.transaction);
...
function aj(a,b){b=void 0===b?{}:b;var c,d,e,f;return z(function(g){if(1==g.h)return sa(g,2),c=self.indexedDB.deleteDatabase(a),d=b,(e=d.blocked)&&c.addEventListener("blocked",function(){e()}),w(g,Ii(c),4);
if(2!=g.h)return ta(g,0);f=ua(g);throw yi(f,a,"",-1);})}
;function bj(a){return new Promise(function(b){Bg(function(){b()},a)})}
function cj(a,b){this.name=a;this.options=b;this.l=!0;this.v=this.m=0;this.i=500}
...
function dj(a,b){return new U("INCOMPATIBLE_DB_VERSION",{dbName:a.name,oldVersion:a.options.version,newVersion:b})}
function ej(a,b){if(!b)throw zi("openWithToken",qi(a.name));return a.open()}
...
p=k.objectStoreNames();if(c.v<tg("ytidb_reopen_db_retries",0))return c.v++,k.close(),ki(new U("DB_REOPENED_BY_MISSING_OBJECT_STORES",{dbName:c.name,expectedObjectStores:n,foundObjectStores:p})),y.return(a());if(!(c.m<tg("ytidb_remake_db_retries",1))){y.o(6);break}c.m++;if(!Q("ytidb_remake_db_enable_backoff_delay")){y.o(7);break}return w(y,bj(c.i),8);case 8:c.i*=2;case 7:return w(y,c.delete(),9);case 9:return ki(new U("DB_DELETED_BY_MISSING_OBJECT_STORES",{dbName:c.name,expectedObjectStores:n,foundObjectStores:p})),
y.return(a());case 6:throw new vi(p,n);case 5:return y.return(k);case 2:u=ua(y);if(u instanceof DOMException?"VersionError"!==u.name:"DOMError"in self&&u instanceof DOMError?"VersionError"!==u.name:!(u instanceof Object&&"message"in u)||"An attempt was made to open a database using a lower version than the existing version."!==u.message){y.o(10);break}return w(y,c.j(c.name,void 0,Object.assign(Object.assign({},e),{upgrade:void 0})),11);case 11:q=y.i;x=q.h.version;if(void 0!==c.options.version&&x>
c.options.version+1)throw q.close(),c.l=!1,dj(c,x);return y.return(q);case 10:throw b(),u instanceof Error&&!Q("ytidb_async_stack_killswitch")&&(u.stack=u.stack+"\n"+h.substring(h.indexOf("\n")+1)),yi(u,c.name,"",null!==(g=c.options.version)&&void 0!==g?g:-1);}})}
function b(){c.h===d&&(c.h=void 0)}
var c=this;if(!this.l)throw dj(this);if(this.h)return this.h;var d,e={blocking:function(f){f.close()},
closed:b,wb:b,upgrade:this.options.upgrade};return this.h=d=a()};var fj=new cj("YtIdbMeta",{ia:{databases:{ya:1}},upgrade:function(a,b){b(1)&&Mi(a,"databases",{keyPath:"actualName"})}});
function gj(a,b){var c;return z(function(d){if(1==d.h)return w(d,ej(fj,b),2);c=d.i;return d.return(Li(c,["databases"],{G:!0,mode:"readwrite"},function(e){var f=e.objectStore("databases");return f.get(a.actualName).then(function(g){if(g?a.actualName!==g.actualName||a.publicName!==g.publicName||a.userIdentifier!==g.userIdentifier:1)return X(f.h.put(a,void 0)).then(function(){})})}))})}
...
function ij(a,b){var c,d;return z(function(e){return 1==e.h?(c=[],w(e,ej(fj,b),2)):3!=e.h?(d=e.i,w(e,Li(d,["databases"],{G:!0,mode:"readonly"},function(f){c.length=0;return Ui(f.objectStore("databases"),{},function(g){a(g.X())&&c.push(g.X());return g.continue()})}),3)):e.return(c)})}
...
function nj(){if(void 0!==kj)return kj;ji=!0;return kj=mj().then(function(a){ji=!1;var b,c;null!==(b=gi())&&void 0!==b&&b.h&&(b=hi(),b={hasSucceededOnce:(null===b||void 0===b?void 0:b.hasSucceededOnce)||a},null===(c=gi())||void 0===c?void 0:c.set("LAST_RESULT_ENTRY_KEY",b,2592E3,!0));return a})}
...
;new De;function qj(a){if(!ni())throw a=new U("AUTH_INVALID",{dbName:a}),ki(a),a;var b=oi();return{actualName:a+":"+b,publicName:a,userIdentifier:b}}
function rj(a,b,c,d){var e,f,g,h,k,l;return z(function(n){switch(n.h){case 1:return f=null!==(e=Error().stack)&&void 0!==e?e:"",w(n,pj(),2);case 2:g=n.i;if(!g)throw h=zi("openDbImpl",a,b),Q("ytidb_async_stack_killswitch")||(h.stack=h.stack+"\n"+f.substring(f.indexOf("\n")+1)),ki(h),h;pi(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:qj(a);sa(n,3);return w(n,gj(k,g),5);case 5:return w(n,$i(k.actualName,b,d),6);case 6:return n.return(n.i);case 3:return l=ua(n),sa(n,7),w(n,hj(k.actualName,
...
function uj(a,b){b=void 0===b?{}:b;var c,d;return z(function(e){if(1==e.h)return w(e,pj(),2);if(3!=e.h){c=e.i;if(!c)return e.return();pi(a);d=qj(a);return w(e,aj(d.actualName,b),3)}return w(e,hj(d.actualName,c),0)})}
...
function wj(){var a=void 0===a?{}:a;var b,c;return z(function(d){if(1==d.h)return w(d,pj(),2);if(3!=d.h){b=d.i;if(!b)return d.return();pi("LogsDatabaseV2");return w(d,jj(b),3)}c=d.i;return w(d,vj(c,a,b),0)})}
function xj(a,b){b=void 0===b?{}:b;var c;return z(function(d){if(1==d.h)return w(d,pj(),2);if(3!=d.h){c=d.i;if(!c)return d.return();pi(a);return w(d,aj(a,b),3)}return w(d,hj(a,c),0)})}
...
this.F=a.F;this.S=a.S;this.Ha=a.Ha;this.Ga=a.Ga;this.s&&(!this.A||this.A("networkless_logging"))&&zj(this)}
function zj(a){return z(function(b){if(1==b.h)return!a.s||a.ea?b.return():a.qa&&Math.random()<=a.pa?w(b,a.C.mb(a.s),2):b.o(2);Aj(a);a.F.D()&&a.ka();a.F.Y(a.Ha,a.ka.bind(a));a.F.Y(a.Ga,a.La.bind(a));a.h=!0;b.h=0})}
...
Cj(d,g)})}else this.S(a,b,this.A&&this.A("nwl_skip_retry")&&c)};
...
this.S(d.url,d.options);this.C.set(d,this.s).then(function(g){d.id=g;e&&c.C.aa(d.id,c.s)}).catch(function(g){Cj(c,g)})}else this.S(a,b)};
m.ka=function(){var a=this;if(!this.s)throw zi("throttleSend");this.i||(this.i=this.K.L(function(){var b;return z(function(c){if(1==c.h)return w(c,a.C.Ra("NEW",a.s),2);if(3!=c.h)return b=c.i,b?w(c,Bj(a,b),3):(a.La(),c.return());a.i&&(a.i=0,a.ka());c.h=0})},this.fb))};
m.La=function(){this.K.W(this.i);this.i=0};
function Bj(a,b){var c,d;return z(function(e){switch(e.h){case 1:if(!a.s)throw c=zi("immediateSend"),c;if(void 0===b.id){e.o(2);break}return w(e,a.C.tb(b.id,a.s),3);case 3:(d=e.i)?b=d:a.ba(Error("The request cannot be found in the database."));case 2:if(Dj(a,b,a.ab)){e.o(4);break}a.ba(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.o(5);break}return w(e,a.C.aa(b.id,a.s),5);case 5:return e.return();case 4:b.skipRetry||(b=Ej(a,b));if(!b){e.o(0);break}if(!b.skipRetry||
void 0===b.id){e.o(8);break}return w(e,a.C.aa(b.id,a.s),8);case 8:a.S(b.url,b.options,!!b.skipRetry),e.h=0}})}
function Ej(a,b){if(!a.s)throw zi("updateRequestHandlers");var c=b.options.onError?b.options.onError:function(){};
b.options.onError=function(e,f){var g;return z(function(h){switch(h.h){case 1:g=Fj(f);if(!(a.A&&a.A("nwl_consider_error_code")&&g||a.A&&!a.A("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.va)){h.o(2);break}if(!a.F.T){h.o(3);break}return w(h,a.F.T(),3);case 3:if(a.F.D()){h.o(2);break}c(e,f);if(!a.A||!a.A("nwl_consider_error_code")||void 0===(null===b||void 0===b?void 0:b.id)){h.o(6);break}return w(h,a.C.Ia(b.id,a.s,!1),6);case 6:return h.return();case 2:if(a.A&&a.A("nwl_consider_error_code")&&
...
function Aj(a){if(!a.s)throw zi("retryQueuedRequests");a.C.Ra("QUEUED",a.s).then(function(b){b&&!Dj(a,b,a.Za)?a.K.L(function(){return z(function(c){if(1==c.h)return void 0===b.id?c.o(2):w(c,a.C.Ia(b.id,a.s),2);Aj(a);c.h=0})}):a.F.D()&&a.ka()})}
function Cj(a,b){a.gb&&!a.F.D()?a.gb(b):a.handleError(b)}
function Fj(a){var b;return(a=null===(b=null===a||void 0===a?void 0:a.error)||void 0===b?void 0:b.code)&&400<=a&&599>=a?!1:!0}
;var Gj=C("ytPubsub2Pubsub2Instance")||new L;L.prototype.subscribe=L.prototype.subscribe;L.prototype.unsubscribeByKey=L.prototype.la;L.prototype.publish=L.prototype.ca;L.prototype.clear=L.prototype.clear;E("ytPubsub2Pubsub2Instance",Gj);E("ytPubsub2Pubsub2SubscribedKeys",C("ytPubsub2Pubsub2SubscribedKeys")||{});E("ytPubsub2Pubsub2TopicToKeys",C("ytPubsub2Pubsub2TopicToKeys")||{});E("ytPubsub2Pubsub2IsAsync",C("ytPubsub2Pubsub2IsAsync")||{});E("ytPubsub2Pubsub2SkipSubKey",null);function Hj(a,b){cj.call(this,a,b);this.options=b;pi(a)}
v(Hj,cj);function Ij(a,b){var c;return function(){c||(c=new Hj(a,b));return c}}
Hj.prototype.j=function(a,b,c){c=void 0===c?{}:c;return(this.options.Ja?tj:sj)(a,b,Object.assign({},c))};
Hj.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.Ja?xj:uj)(this.name,a)};
function Jj(a,b){return Ij(a,b)}
;var Kj;
function Lj(){if(Kj)return Kj();var a={};Kj=Jj("LogsDatabaseV2",{ia:(a.LogsRequestsStore={ya:2},a),Ja:!1,upgrade:function(b,c,d){c(2)&&Mi(b,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0});c(3);c(5)&&(d=d.objectStore("LogsRequestsStore"),d.h.indexNames.contains("newRequest")&&d.h.deleteIndex("newRequest"),d.h.createIndex("newRequestV2",["status","interface","timestamp"],{unique:!1}));c(7)&&b.h.objectStoreNames.contains("sapisid")&&b.h.deleteObjectStore("sapisid");c(9)&&b.h.objectStoreNames.contains("SWHealthLog")&&b.h.deleteObjectStore("SWHealthLog")},
version:9});return Kj()}
;function Mj(a){return ej(Lj(),a)}
function Nj(a,b){var c,d,e,f;return z(function(g){if(1==g.h)return c={startTime:R(),transactionType:"YT_IDB_TRANSACTION_TYPE_WRITE"},w(g,Mj(b),2);if(3!=g.h)return d=g.i,e=Object.assign(Object.assign({},a),{options:JSON.parse(JSON.stringify(a.options)),interface:N("INNERTUBE_CONTEXT_CLIENT_NAME",0)}),w(g,Oi(d,e),3);f=g.i;c.xb=R();Oj(c);return g.return(f)})}
function Pj(a,b){var c,d,e,f,g,h,k;return z(function(l){if(1==l.h)return c={startTime:R(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},w(l,Mj(b),2);if(3!=l.h)return d=l.i,e=N("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=[a,e,0],g=[a,e,R()],h=IDBKeyRange.bound(f,g),k=void 0,w(l,Li(d,["LogsRequestsStore"],{mode:"readwrite",G:!0},function(n){return Xi(n.objectStore("LogsRequestsStore").index("newRequestV2"),{query:h,direction:"prev"},function(p){p.X()&&(k=p.X(),"NEW"===a&&(k.status="QUEUED",p.update(k)))})}),
3);
c.xb=R();Oj(c);return l.return(k)})}
function Qj(a,b){var c;return z(function(d){if(1==d.h)return w(d,Mj(b),2);c=d.i;return d.return(Li(c,["LogsRequestsStore"],{mode:"readwrite",G:!0},function(e){var f=e.objectStore("LogsRequestsStore");return f.get(a).then(function(g){if(g)return g.status="QUEUED",X(f.h.put(g,void 0)).then(function(){return g})})}))})}
function Rj(a,b,c){c=void 0===c?!0:c;var d;return z(function(e){if(1==e.h)return w(e,Mj(b),2);d=e.i;return e.return(Li(d,["LogsRequestsStore"],{mode:"readwrite",G:!0},function(f){var g=f.objectStore("LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",c&&(h.sendCount+=1),X(g.h.put(h,void 0)).then(function(){return h})):W.resolve(void 0)})}))})}
function Sj(a,b){var c;return z(function(d){if(1==d.h)return w(d,Mj(b),2);c=d.i;return d.return(c.delete("LogsRequestsStore",a))})}
function Tj(a){var b,c;return z(function(d){if(1==d.h)return w(d,Mj(a),2);b=d.i;c=R()-2592E6;return w(d,Li(b,["LogsRequestsStore"],{mode:"readwrite",G:!0},function(e){return Ui(e.objectStore("LogsRequestsStore"),{},function(f){if(f.X().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
function Uj(){z(function(a){return w(a,wj(),0)})}
function Oj(a){if(!Q("nwl_csi_killswitch")&&.01>=Math.random()){var b=C("ytPubsub2Pubsub2Instance");b&&b.publish.call(b,"nwl_transaction_latency_payload".toString(),"nwl_transaction_latency_payload",a)}}
;var Vj={},Wj=Jj("ServiceWorkerLogsDatabase",{ia:(Vj.SWHealthLog={ya:1},Vj),Ja:!0,upgrade:function(a,b){b(1)&&Mi(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).h.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
version:1});function Xj(a){return ej(Wj(),a)}
function Zj(a){var b,c;z(function(d){if(1==d.h)return w(d,Xj(a),2);b=d.i;c=R()-2592E6;return w(d,Li(b,["SWHealthLog"],{mode:"readwrite",G:!0},function(e){return Ui(e.objectStore("SWHealthLog"),{},function(f){if(f.X().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
...
function bk(){if(!Y.h){var a=C("yt.networkRequestMonitor.instance")||new Y;E("yt.networkRequestMonitor.instance",a);Y.h=a}return Y.h}
...
Y.prototype.removeParams=Y.prototype.removeParams;Y.prototype.isEndpointCFR=Y.prototype.isEndpointCFR;Y.prototype.requestComplete=Y.prototype.requestComplete;Y.getInstance=bk;var ck;function dk(){ck||(ck=new ai("yt.offline"));return ck}
function ek(a){if(Q("offline_error_handling")){var b=dk().get("errors",!0)||{};b[a.message]={name:a.name,stack:a.stack};a.level&&(b[a.message].level=a.level);dk().set("errors",b,2592E3,!0)}}
function fk(){if(Q("offline_error_handling")){var a=dk().get("errors",!0);if(a){for(var b in a)if(a[b]){var c=new mi(b,"sent via offline_errors");c.name=a[b].name;c.stack=a[b].stack;c.level=a[b].level;Yf(c)}dk().set("errors",{},2592E3,!0)}}}
;var gk=tg("network_polling_interval",3E4);function Z(){K.call(this);this.O=0;this.ma=this.m=!1;this.j=this.Aa();Q("use_shared_nsm")?(Od.h||(Od.h=new Od(Eg)),this.i=Od.h):(hk(this),ik(this))}
v(Z,K);function jk(){if(!Z.h){var a=C("yt.networkStatusManager.instance")||new Z;E("yt.networkStatusManager.instance",a);Z.h=a}return Z.h}
...
m.ub=function(a){!Q("use_shared_nsm")&&(this.m=!0,void 0===a?0:a)&&(this.O||kk(this))};
...
function ik(a){window.addEventListener("online",function(){return z(function(b){if(1==b.h)return w(b,a.T(),2);a.ma&&fk();b.h=0})})}
function hk(a){window.addEventListener("offline",function(){return z(function(b){return w(b,a.T(),0)})})}
function kk(a){a.O=zg(function(){return z(function(b){if(1==b.h)return a.j?a.Aa()||!a.m?b.o(3):w(b,a.T(),3):w(b,a.T(),3);kk(a);b.h=0})},gk)}
m.T=function(a){var b=this;if(Q("use_shared_nsm")&&this.i){var c=Pd(this.i,a);c.then(function(d){Q("use_cfr_monitor")&&bk().requestComplete("generate_204",d)});
...
signal:f}),5);case 5:g=!0;case 3:va(h);Q("use_cfr_monitor")&&bk().requestComplete("generate_204",g);b.u=void 0;b.B&&Eg.W(b.B);g!==b.j&&(b.j=g,b.j&&b.m?Md(b,"ytnetworkstatus-online"):b.m&&Md(b,"ytnetworkstatus-offline"));d(g);xa(h);break;case 2:ua(h),g=!1,h.o(3)}})})};
Z.prototype.sendNetworkCheckRequest=Z.prototype.T;Z.prototype.listen=Z.prototype.Y;Z.prototype.enableErrorFlushing=Z.prototype.ob;Z.prototype.getWindowStatus=Z.prototype.Aa;Z.prototype.monitorNetworkStatusChange=Z.prototype.ub;Z.prototype.networkStatusHint=Z.prototype.P;Z.prototype.isNetworkAvailable=Z.prototype.D;Z.getInstance=jk;function lk(a){a=void 0===a?{}:a;K.call(this);var b=this;this.j=this.O=0;this.m="ytnetworkstatus-offline";this.u="ytnetworkstatus-online";Q("use_shared_nsm")&&(this.m="networkstatus-offline",this.u="networkstatus-online");this.i=jk();var c=C("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.i);c&&c(a.Oa);a.sa&&!Q("use_shared_nsm")&&(c=C("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i))&&c();if(c=C("yt.networkStatusManager.instance.listen").bind(this.i))a.wa?
(this.wa=a.wa,c(this.u,function(){mk(b,"publicytnetworkstatus-online");Q("use_shared_nsm")&&a.sa&&fk()}),c(this.m,function(){mk(b,"publicytnetworkstatus-offline")})):(c(this.u,function(){Md(b,"publicytnetworkstatus-online");
Q("use_shared_nsm")&&a.sa&&fk()}),c(this.m,function(){Md(b,"publicytnetworkstatus-offline")}))}
v(lk,K);lk.prototype.D=function(){var a=C("yt.networkStatusManager.instance.isNetworkAvailable");return a?a.bind(this.i)():!0};
lk.prototype.P=function(a){var b=C("yt.networkStatusManager.instance.networkStatusHint").bind(this.i);b&&b(a)};
lk.prototype.T=function(a){var b=this,c;return z(function(d){c=C("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.i);return Q("skip_network_check_if_cfr")&&bk().isEndpointCFR("generate_204")?d.return(new Promise(function(e){var f;b.P((null===(f=window.navigator)||void 0===f?void 0:f.onLine)||!0);e(b.D())})):c?d.return(c(a)):d.return(!0)})};
function mk(a,b){a.wa?a.j?(Eg.W(a.O),a.O=Eg.L(function(){a.B!==b&&(Md(a,b),a.B=b,a.j=R())},a.wa-(R()-a.j))):(Md(a,b),a.B=b,a.j=R()):Md(a,b)}
;var nk;function ok(){yj.call(this,{C:{mb:Tj,aa:Sj,Ra:Pj,tb:Qj,Ia:Rj,set:Nj},F:pk(),handleError:Yf,ba:Zf,S:qk,now:R,gb:ek,K:Dg(),Ha:"publicytnetworkstatus-online",Ga:"publicytnetworkstatus-offline",qa:!0,pa:.1,va:tg("potential_esf_error_limit",10),A:Q,ea:!ni()});this.j=new De;this.qa&&Math.random()<=this.pa&&this.s&&Zj(this.s);Q("networkless_immediately_drop_sw_health_store")&&rk(this);Q("networkless_immediately_drop_all_requests")&&Uj();xj("LogsDatabaseV2")}
v(ok,yj);function sk(){var a=C("yt.networklessRequestController.instance");a||(a=new ok,E("yt.networklessRequestController.instance",a),Q("networkless_logging")&&pj().then(function(b){return z(function(c){if(1==c.h)return a.s=b,w(c,zj(a),2);a.j.resolve();c.h=0})}));
return a}
ok.prototype.writeThenSend=function(a,b){b||(b={});ni()||(this.h=!1);yj.prototype.writeThenSend.call(this,a,b)};
ok.prototype.sendThenWrite=function(a,b,c){b||(b={});ni()||(this.h=!1);yj.prototype.sendThenWrite.call(this,a,b,c)};
ok.prototype.sendAndWrite=function(a,b){b||(b={});ni()||(this.h=!1);yj.prototype.sendAndWrite.call(this,a,b)};
ok.prototype.awaitInitialization=function(){return this.j.promise};
function rk(a){var b;z(function(c){if(!a.s)throw b=zi("clearSWHealthLogsDb"),b;return c.return(ak(a.s).catch(function(d){a.handleError(d)}))})}
function qk(a,b,c){Q("use_cfr_monitor")&&tk(a,b);var d;if(null===(d=b.postParams)||void 0===d?0:d.requestTimeMs)b.postParams.requestTimeMs=Math.round(R());c&&0===Object.keys(b).length?$g(a):Og(a,b)}
function pk(){nk||(nk=new lk({sa:!0,Oa:!0}));return nk}
function tk(a,b){var c=b.onError?b.onError:function(){};
b.onError=function(e,f){bk().requestComplete(a,!1);c(e,f)};
var d=b.onSuccess?b.onSuccess:function(){};
b.onSuccess=function(e,f){bk().requestComplete(a,!0);d(e,f)}}
;var uk=0,vk=0,wk,xk=B.ytNetworklessLoggingInitializationOptions||{isNwlInitialized:!1,potentialEsfErrorCounter:vk};E("ytNetworklessLoggingInitializationOptions",xk);function yk(a,b){function c(d){var e=zk().D();if(!Ak()||!d||e&&Q("vss_networkless_bypass_write"))Bk(a,b);else{var f={url:a,options:b,timestamp:R(),status:"NEW",sendCount:0};Nj(f,d).then(function(g){f.id=g;zk().D()&&Ck(f)}).catch(function(g){Ck(f);
zk().D()?Yf(g):ek(g)})}}
b=void 0===b?{}:b;Q("skip_is_supported_killswitch")?pj().then(function(d){c(d)}):c(oj())}
function Dk(a,b){function c(d){if(Ak()&&d){var e={url:a,options:b,timestamp:R(),status:"NEW",sendCount:0},f=!1,g=b.onSuccess?b.onSuccess:function(){};
e.options.onSuccess=function(k,l){Q("use_cfr_monitor")&&bk().requestComplete(e.url,!0);void 0!==e.id?Sj(e.id,d):f=!0;Q("vss_network_hint")&&zk().P(!0);g(k,l)};
if(Q("use_cfr_monitor")){var h=b.onError?b.onError:function(){};
e.options.onError=function(k,l){bk().requestComplete(e.url,!1);h(k,l)}}Bk(e.url,e.options);
Nj(e,d).then(function(k){e.id=k;f&&Sj(e.id,d)}).catch(function(k){zk().D()?Yf(k):ek(k)})}else Bk(a,b)}
b=void 0===b?{}:b;Q("skip_is_supported_killswitch")?pj().then(function(d){c(d)}):c(oj())}
function Ek(){var a=oj();if(!a)throw zi("throttleSend");uk||(uk=Eg.L(function(){var b;return z(function(c){if(1==c.h)return w(c,Pj("NEW",a),2);if(3!=c.h)return b=c.i,b?w(c,Ck(b),3):(Eg.W(uk),uk=0,c.return());uk&&(uk=0,Ek());c.h=0})},100))}
function Ck(a){var b,c,d;return z(function(e){switch(e.h){case 1:b=oj();if(!b)throw c=zi("immediateSend"),c;if(void 0===a.id){e.o(2);break}return w(e,Qj(a.id,b),3);case 3:(d=e.i)?a=d:Zf(Error("The request cannot be found in the database."));case 2:var f=a.timestamp;if(!(2592E6<=R()-f)){e.o(4);break}Zf(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){e.o(5);break}return w(e,Sj(a.id,b),5);case 5:return e.return();case 4:a.skipRetry||(a=Fk(a));f=a;var g,h;if(null===
(h=null===(g=null===f||void 0===f?void 0:f.options)||void 0===g?void 0:g.postParams)||void 0===h?0:h.requestTimeMs)f.options.postParams.requestTimeMs=Math.round(R());a=f;if(!a){e.o(0);break}if(!a.skipRetry||void 0===a.id){e.o(8);break}return w(e,Sj(a.id,b),8);case 8:Bk(a.url,a.options,!!a.skipRetry),e.h=0}})}
function Fk(a){var b=oj();if(!b)throw zi("updateRequestHandlers");var c=a.options.onError?a.options.onError:function(){};
a.options.onError=function(e,f){var g;return z(function(h){switch(h.h){case 1:Q("use_cfr_monitor")&&bk().requestComplete(a.url,!1);g=Fj(f);if(!(Q("nwl_consider_error_code")&&g||!Q("nwl_consider_error_code")&&Gk()<=tg("potential_esf_error_limit",10))){h.o(2);break}if(Q("skip_checking_network_on_cfr_failure")&&(!Q("skip_checking_network_on_cfr_failure")||bk().isEndpointCFR(a.url))){h.o(3);break}return w(h,zk().T(),3);case 3:if(zk().D()){h.o(2);break}c(e,f);if(!Q("nwl_consider_error_code")||void 0===
(null===a||void 0===a?void 0:a.id)){h.o(6);break}return w(h,Rj(a.id,b,!1),6);case 6:return h.return();case 2:if(Q("nwl_consider_error_code")&&!g&&Gk()>tg("potential_esf_error_limit",10))return h.return();C("ytNetworklessLoggingInitializationOptions")&&xk.potentialEsfErrorCounter++;vk++;if(void 0===(null===a||void 0===a?void 0:a.id)){h.o(8);break}return 1>a.sendCount?w(h,Rj(a.id,b),12):w(h,Sj(a.id,b),8);case 12:Eg.L(function(){zk().D()&&Ek()},5E3);
case 8:c(e,f),h.h=0}})};
var d=a.options.onSuccess?a.options.onSuccess:function(){};
a.options.onSuccess=function(e,f){return z(function(g){if(1==g.h)return Q("use_cfr_monitor")&&bk().requestComplete(a.url,!0),void 0===(null===a||void 0===a?void 0:a.id)?g.o(2):w(g,Sj(a.id,b),2);Q("vss_network_hint")&&zk().P(!0);d(e,f);g.h=0})};
return a}
function zk(){if(Q("use_new_nwl"))return pk();wk||(wk=new lk({sa:!0,Oa:!0}));return wk}
function Bk(a,b,c){c&&0===Object.keys(b).length?$g(a):Og(a,b)}
function Ak(){return C("ytNetworklessLoggingInitializationOptions")?xk.isNwlInitialized:!1}
function Gk(){return C("ytNetworklessLoggingInitializationOptions")?xk.potentialEsfErrorCounter:vk}
;function Hk(a){var b=this;this.config_=null;a?this.config_=a:Th()&&(this.config_=Bh());zg(function(){fi(b)},5E3)}
Hk.prototype.isReady=function(){!this.config_&&Th()&&(this.config_=Bh());return!!this.config_};
function Fh(a,b,c,d){function e(x){x=void 0===x?!1:x;var y;if(d.retry&&"www.youtube-nocookie.com"!=h&&(x||Q("skip_ls_gel_retry")||"application/json"!==g.headers["Content-Type"]||(y=di(b,c,l,k)),y)){var A=g.onSuccess,M=g.onFetchSuccess;g.onSuccess=function(O,P){ei(y);A(O,P)};
c.onFetchSuccess=function(O,P){ei(y);M(O,P)}}try{x&&d.retry&&!d.Xa.bypassNetworkless?(g.method="POST",d.Xa.writeThenSend?Q("use_new_nwl")?sk().writeThenSend(q,g):yk(q,g):Q("use_new_nwl")?sk().sendAndWrite(q,g):Dk(q,g)):(g.method="POST",g.postParams||(g.postParams={}),Og(q,g))}catch(O){if("InvalidAccessError"==O.name)y&&(ei(y),y=0),Zf(Error("An extension is blocking network request."));
else throw O;}y&&zg(function(){fi(a)},5E3)}
...
h+n,p||{},!0);Q("use_new_nwl")&&sk().h||!Q("use_new_nwl")&&Ak()?nj().then(function(x){e(x)}):e(!1)}
;function Ik(a,b){var c=void 0===c?{}:c;var d=Hk;N("ytLoggingEventsDefaultDisabled",!1)&&Hk==Hk&&(d=null);a:{c=void 0===c?{}:c;if(Q("lr_drop_other_and_business_payloads")){if(xg[a]||wg[a])break a}else if(Q("lr_drop_other_payloads")&&xg[a])break a;var e={},f=Math.round(c.timestamp||R());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=C("_lact",window);a=null==a?-1:Math.max(Date.now()-a,0);e.context={lastActivityMs:String(c.timestamp||!isFinite(a)?-1:a)};Q("log_sequence_info_on_gel_web")&&c.eb&&
...
;var Jk=[{Fa:function(a){return"Cannot read property '"+a.key+"'"},
...
ta:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var Lk={V:[],U:[{kb:Kk,weight:500}]};function Kk(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function Mk(){this.U=[];this.V=[]}
var Nk;function Ok(){if(!Nk){var a=Nk=new Mk;a.V.length=0;a.U.length=0;Lk.V&&a.V.push.apply(a.V,Lk.V);Lk.U&&a.U.push.apply(a.U,Lk.U)}return Nk}
...
;function Sk(a,b,c,d){if(a)if(Array.isArray(a)){var e=d;for(d=0;d<a.length&&!(a[d]&&(e+=Tk(d,a[d],b,c),500<e));d++);d=e}else if("object"===typeof a)for(e in a){if(a[e]){var f=a[e];var g=b;var h=c;g="string"!==typeof f||"clickTrackingParams"!==e&&"trackingParams"!==e?0:(f=Qk(atob(f.replace(/-/g,"+").replace(/_/g,"/"))))?Tk(e+".ve",f,g,h):0;d+=g;d+=Tk(e,a[e],b,c);if(500<d)break}}else c[b]=Uk(a),d+=c[b].length;else c[b]=Uk(a),d+=c[b].length;return d}
function Tk(a,b,c,d){c+="."+a;a=Uk(b);d[c]=a;return c.length+a.length}
function Uk(a){try{return("string"===typeof a?a:String(JSON.stringify(a))).substr(0,500)}catch(b){return"unable to serialize "+typeof a+" ("+b.message+")"}}
;var Vk=new Set,Wk=0,Xk=0,Yk=0,Zk=[],$k=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];var al={};function bl(a){return al[a]||(al[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var cl={},dl=[],Ve=new L,el={};function fl(){for(var a=t(dl),b=a.next();!b.done;b=a.next())b=b.value,b()}
function gl(a,b){var c;"yt:"===a.tagName.toLowerCase().substr(0,3)?c=a.getAttribute(b):c=a?a.dataset?a.dataset[bl(b)]:a.getAttribute("data-"+b):null;return c}
function hl(a){Ve.ca.apply(Ve,arguments)}
;function il(a){this.h=a||{};a=[this.h,window.YTConfig||{}];for(var b=0;b<a.length;b++)a[b].host&&(a[b].host=a[b].host.toString().replace("http://","https://"))}
function jl(a,b){a=[a.h,window.YTConfig||{}];for(var c=0;c<a.length;c++){var d=a[c][b];if(void 0!==d)return d}return null}
function kl(a,b,c){ll||(ll={},gg(window,"message",function(d){a:{if(d.origin===jl(a,"host")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}if(d=ll[e.id])d.u=!0,d.u&&(G(d.v,d.sendMessage,d),d.v.length=0),d.Ka(e)}e=void 0}return e}));
ll[c]=b}
var ll=null;function ml(a,b,c){this.m=this.h=this.i=null;this.j=0;this.u=!1;this.v=[];this.l=null;this.I={};if(!a)throw Error("YouTube player element ID required.");this.id=Ma(this);this.B=c;this.setup(a,b)}
...
m.destroy=function(){this.h&&this.h.id&&(cl[this.h.id]=null);(0,hd)(this.l);if(this.m){var a=this.h,b=a.parentNode;b&&b.replaceChild(this.m,a)}else(a=this.h)&&a.parentNode&&a.parentNode.removeChild(a);ll&&(ll[this.id]=null);this.i=null;a=this.h;for(var c in db)db[c][0]==a&&eg(c);this.m=this.h=null};
m.Na=function(){return{}};
function ql(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.u?a.sendMessage(b):a.v.push(b)}
function nl(a,b,c){a.l.l||(c={target:a,data:c},a.l.ca(b,c),hl(a.B+"."+b,c))}
function rl(a,b){var c=document.createElement("iframe");b=b.attributes;for(var d=0,e=b.length;d<e;d++){var f=b[d].value;null!=f&&""!==f&&"null"!==f&&c.setAttribute(b[d].name,f)}c.setAttribute("frameBorder","0");c.setAttribute("allowfullscreen","1");c.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture");c.setAttribute("title","YouTube "+jl(a.i,"title"));(b=jl(a.i,"width"))&&c.setAttribute("width",b.toString());(b=jl(a.i,"height"))&&c.setAttribute("height",
...
window.yt_embedsTokenValue&&(g.embedsTokenValue=encodeURIComponent(window.yt_embedsTokenValue),delete window.yt_embedsTokenValue);c.src=jl(a.i,"host")+("/embed/"+jl(a.i,"videoId"))+"?"+Lb(g);return c}
...
m.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Jb(a.src):"https://www.youtube.com"),this.i=new il(b),c||(b=rl(this,a),this.m=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.h=a,this.h.id||(this.h.id="widget"+Ma(this.h)),cl[this.h.id]=this,window.postMessage){this.l=new L;sl(this);b=jl(this.i,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in el)el.hasOwnProperty(e)&&
pl(this,e)}};
...
e.level&&(d=e.level);if(Q("console_log_js_exceptions")){var g=e,h=[];h.push("Name: "+g.name);h.push("Message: "+g.message);g.hasOwnProperty("params")&&h.push("Error Params: "+JSON.stringify(g.params));g.hasOwnProperty("args")&&h.push("Error args: "+JSON.stringify(g.args));h.push("File name: "+g.fileName);h.push("Stacktrace: "+g.stack);window.console.log(h.join("\n"),g)}if(!(5<=Wk)){g=void 0;var k=f,l=kd(e);f=l.message||"Unknown Error";h=l.name||"UnknownError";var n=l.stack||e.i||"Not available";if(n.startsWith(h+
": "+f)){var p=n.split("\n");p.shift();n=p.join("\n")}p=l.lineNumber||"Not available";l=l.fileName||"Not available";var u=0;if(e.hasOwnProperty("args")&&e.args&&e.args.length)for(g=0;g<e.args.length&&!(u=Sk(e.args[g],"params."+g,k,u),500<=u);g++);else if(e.hasOwnProperty("params")&&e.params){var q=e.params;if("object"===typeof e.params)for(g in q){if(q[g]){var x="params."+g,y=Uk(q[g]);k[x]=y;u+=x.length+y.length;if(500<u)break}}else k.params=Uk(q)}if(Zk.length)for(g=0;g<Zk.length&&!(u=Sk(Zk[g],"params.context."+
g,k,u),500<=u);g++);navigator.vendor&&!k.hasOwnProperty("vendor")&&(k["device.vendor"]=navigator.vendor);g={message:f,name:h,lineNumber:p,fileName:l,stack:n,params:k,sampleWeight:1};f=Number(e.columnNumber);isNaN(f)||(g.lineNumber=g.lineNumber+":"+f);if("IGNORED"===e.level)e=0;else a:{e=Ok();f=t(e.V);for(h=f.next();!h.done;h=f.next())if(h=h.value,g.message&&g.message.match(h.Wb)){e=h.weight;break a}e=t(e.U);for(f=e.next();!f.done;f=e.next())if(f=f.value,f.kb(g)){e=f.weight;break a}e=1}g.sampleWeight=
e;e=g;g=t(Jk);for(f=g.next();!f.done;f=g.next())if(f=f.value,f.ta[e.name])for(p=t(f.ta[e.name]),h=p.next();!h.done;h=p.next())if(l=h.value,h=e.message.match(l.regexp)){e.params["params.error.original"]=h[0];p=l.groups;l={};for(n=0;n<p.length;n++)l[p[n]]=h[n+1],e.params["params.error."+p[n]]=h[n+1];e.message=f.Fa(l);break}e.params||(e.params={});g=Ok();e.params["params.errorServiceSignature"]="msg="+g.V.length+"&cb="+g.U.length;e.params["params.serviceWorker"]="false";B.document&&B.document.querySelectorAll&&
(e.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));lb("sample").constructor!==jb&&(e.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(e);if(0!==e.sampleWeight&&!Vk.has(e.message)){"ERROR"===d?(Pk.ca("handleError",e),Q("record_app_crashed_web")&&0===Yk&&1===e.sampleWeight&&(Yk++,g={appCrashType:"APP_CRASH_TYPE_BREAKPAD"},Q("report_client_error_with_app_crash_ks")||(g.systemHealth={crashData:{clientError:{logMessage:{message:e.message}}}}),
Ik("appCrashed",g)),Xk++):"WARNING"===d&&Pk.ca("handleWarning",e);if(Q("kevlar_gel_error_routing")){g=d;h=e;b:{f=t($k);for(p=f.next();!p.done;p=f.next())if(Xg(p.value.toLowerCase())){f=!0;break b}f=!1}if(f)f=void 0;else{p={stackTrace:h.stack};h.fileName&&(p.filename=h.fileName);f=h.lineNumber&&h.lineNumber.split?h.lineNumber.split(":"):[];0!==f.length&&(1!==f.length||isNaN(Number(f[0]))?2!==f.length||isNaN(Number(f[0]))||isNaN(Number(f[1]))||(p.lineNumber=Number(f[0]),p.columnNumber=Number(f[1])):
p.lineNumber=Number(f[0]));f={level:"ERROR_LEVEL_UNKNOWN",message:h.message,errorClassName:h.name,sampleWeight:h.sampleWeight};"ERROR"===g?f.level="ERROR_LEVEL_ERROR":"WARNING"===g&&(f.level="ERROR_LEVEL_WARNNING");p={isObfuscated:!0,browserStackInfo:p};l={pageUrl:window.location.href,kvPairs:[]};N("FEXP_EXPERIMENTS")&&(l.experimentIds=N("FEXP_EXPERIMENTS"));n=Uf();k=(k=Nf.EXPERIMENT_FLAGS)?k.web_disable_gel_stp_ecatcher_killswitch:void 0;if(!k&&n)for(u=t(Object.keys(n)),k=u.next();!k.done;k=u.next())k=
k.value,l.kvPairs.push({key:k,value:String(n[k])});if(h=h.params)for(n=t(Object.keys(h)),k=n.next();!k.done;k=n.next())k=k.value,l.kvPairs.push({key:"client."+k,value:String(h[k])});h=N("SERVER_NAME",void 0);n=N("SERVER_VERSION",void 0);h&&n&&(l.kvPairs.push({key:"server.name",value:h}),l.kvPairs.push({key:"server.version",value:n}));f={errorMetadata:l,stackTrace:p,logMessage:f}}f&&(Ik("clientError",f),("ERROR"===g||Q("errors_flush_gel_always_killswitch"))&&vh())}if(!Q("suppress_error_204_logging")){f=
...
g[h];g=N("SERVER_NAME",void 0);f=N("SERVER_VERSION",void 0);g&&f&&(d.postParams["server.name"]=g,d.postParams["server.version"]=f)}Og(N("ECATCHER_REPORT_HOST","")+"/error_204",d)}try{Vk.add(e.message)}catch(M){}Wk++}}}}}else throw A;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function tl(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
v(vl,ml);m=vl.prototype;m.Na=function(){var a=jl(this.i,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=jl(this.i,"embedConfig")){if(D(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
...
return this})},a)}
m.getVideoEmbedCode=function(){var a=jl(this.i,"host")+("/embed/"+jl(this.i,"videoId")),b=Number(jl(this.i,"width")),c=Number(jl(this.i,"height"));if(isNaN(b)||isNaN(c))throw Error("Invalid width or height property");b=Math.floor(b);c=Math.floor(c);a=nb(a,void 0);return'<iframe width="'+b+'" height="'+c+'" src="'+a+'" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'};
...
function yl(a){if("iframe"!==a.tagName.toLowerCase()){var b=gl(a,"videoid");b&&(b={videoId:b,width:gl(a,"width"),height:gl(a,"height")},new vl(a,b))}}
;E("YT.PlayerState.UNSTARTED",-1);E("YT.PlayerState.ENDED",0);E("YT.PlayerState.PLAYING",1);E("YT.PlayerState.PAUSED",2);E("YT.PlayerState.BUFFERING",3);E("YT.PlayerState.CUED",5);E("YT.get",function(a){return cl[a]});
E("YT.scan",fl);E("YT.subscribe",function(a,b,c){Ve.subscribe(a,b,c);el[a]=!0;for(var d in cl)cl.hasOwnProperty(d)&&pl(cl[d],a)});
...
dl.push(function(a){var b=a;b||(b=document);a=$a(b.getElementsByTagName("yt:player"));var c=b||document;if(c.querySelectorAll&&c.querySelector)b=c.querySelectorAll(".yt-player");else{var d;c=document;b=b||c;if(b.querySelectorAll&&b.querySelector)b=b.querySelectorAll(".yt-player");else if(b.getElementsByClassName){var e=b.getElementsByClassName("yt-player");b=e}else{e=b.getElementsByTagName("*");var f={};for(c=d=0;b=e[c];c++){var g=b.className,h;if(h="function"==typeof g.split)h=0<=Wa(g.split(/\s+/),
"yt-player");h&&(f[d++]=b)}f.length=d;b=f}}b=$a(b);G(Za(a,b),yl)});
"undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||fl();var zl=B.onYTReady;zl&&zl();var Al=B.onYouTubeIframeAPIReady;Al&&Al();var Bl=B.onYouTubePlayerAPIReady;Bl&&Bl();}).call(this);
